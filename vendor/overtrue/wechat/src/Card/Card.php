...
class Card extends AbstractAPI
{
    ...
    const API_ACTIVATE_TEMP_INFO = 'https://api.weixin.qq.com/card/membercard/activatetempinfo/get';
    ...
    public function getactivatetempinfo()
    {
        $params=[
            "activate_ticket" => $_GET['activate_ticket']
        ];
        return $this->parseJSON('json', [self::API_ACTIVATE_TEMP_INFO,$params]);
    }
