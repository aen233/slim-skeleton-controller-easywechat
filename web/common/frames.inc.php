...
$ms['mc'][] = array(
	'title' => '微信会员中心',
	'items' => array(
		array('title' => '微信会员列表', 			'url' => url('mc/wx_member')),
		array('title' => '微信会员信息', 			'url' => url('mc/wx_memberinfo')),
		array('title' => '微信会员积分管理', 		'url' => url('mc/wx_memberscore'))
	)
);
$ms['mc'][] = array(
	'title' => '会员卡管理',
	'items' => array(
		...
		array('title' => '微信会员卡管理', 	'url' => url('mc/wxcard')),
